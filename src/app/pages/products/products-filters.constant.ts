...
import {
  DynamicFormFieldInterface,
  FormFieldTypeEnum
} from '../../shared/components/forms/dynamic-form-field/dynamic-form-field.model';

export const MIN_PRODUCTS_PRICE = 1;
export const MAX_PRODUCTS_PRICE = 1000;

export const productsFilters: DynamicFormFieldInterface[] = [
  {
    id: 'categories',
    label: 'Categories',
